/**
 * Daily water target (ml) from body weight (kg), age (years), & gender.
 * Clamped to a practical range for hydration tracking (1000ml to 6000ml).
 */
function calculateDailyGoal(weightKg, ageYears, gender) {
